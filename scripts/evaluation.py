...
class EvaluationScript:
    """
    Script for evaluating the CLIP model on a given test dataset.
    Computes embeddings for images and texts and provides visualization.
    """

    def __init__(self, model_checkpoint_path, test_dataset_path, batch_size=32):
        """
        Initializes the evaluation script with given parameters.
        Args:
            model_checkpoint_path: Path to the trained model's checkpoint.
            test_dataset_path: Path to the dataset used for evaluation.
            batch_size: Number of samples to process at once during evaluation.
        """
